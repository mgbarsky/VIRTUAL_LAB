from flask import *
from lab_db import *
import Entity, Problem, Level, Student, Game, Run
...
===========================
"""
@app.route('/service/python', methods=['POST'])
def service_python():
    if not request.json:
        return
    ...
    if not 'tests' in request.json:
        return

    Run.ParsePython(conn, request.json)
